...
$subject = 'Novo contato - IBYT Software';
...
$service_name = $services[$service] ?? 'Não informado';
...
<body>
    <div class='container'>
        <div class='header'>
            <h2>Novo Contato - IBYT Software</h2>
        </div>
        <div class='content'>
            <div class='field'>
        ...
        <div class='footer'>
            IBYT Software - Sistema de Contato
        </div>
    </div>
</body>
</html>
...
if (mail($to, $subject, $email_body, implode("\r\n", $headers))) {
    ...
    echo json_encode(['success' => false, 'message' => 'Erro ao enviar mensagem. Tente novamente ou entre em contato pelo WhatsApp.']);
}
?>
